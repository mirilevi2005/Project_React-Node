...
// import { Link as RouterLink } from 'react-router-dom'; // שונה שם כדי למנוע התנגשות עם Link של MUI
...
const CourseDisplayCard: React.FC<CourseDisplayCardProps> = ({
  ...
  return (
    <Link
      ...
      to={linkTo} // ✅ שימוש בפרופ במקום קישור מקודד
